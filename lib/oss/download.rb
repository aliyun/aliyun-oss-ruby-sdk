    ...
    module Multipart
      ...
      class Download < Transaction
        def initialize(opts)
          ...
          @parts = []
          @object_meta = Protocol.get_object_meta(bucket, object)
        end
        ...
        def rebuild!
          ...
          if File.exists?(@checkpoint_file)
            ...
            raise ObjectInconsistentError.new("The object is changed.") \
                                             if status['object_etag'] != @object_meta.etag
        ...
        def divide_parts!
          ...
          object_size = Protocol.get_object_meta(bucket, object).size
